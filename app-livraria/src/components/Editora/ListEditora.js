...
Editoras</h2> 
        <div className='row'> 
            ...
            <p><Link to="/addEditora" className="btn btn
success">Adicionar nova Editora</Link></p> 
                ...
                {editoras.map((editora) => { 
                        return ( 
                            <tr> 
                                ...
                                <td> 
                                    <Link 
to={`/readEditora/${editora.id}`} className="btn btn-success mx
2">Ler</Link> 
                                    <Link 
to={`/updateEditora/${editora.id}`} className="btn btn-info mx
2">Editar</Link> 
                                    <button 
onClick={()=>handleDelete(editora.id)} className="btn btn
